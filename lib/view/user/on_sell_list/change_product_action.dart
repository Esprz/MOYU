...
class ChangeProductAction extends StatelessWidget {
  ChangeProductAction(this.item);
  ...
  _onPressNewOld(String i, BuildContext context) async {
    item['newold'] = i;
    await Provider.of<ChangeOnSellDataCenter>(context, listen: false)
        .changeNewold(i);
  }
  ...
  Widget _sellPrice(BuildContext context) {
    var _selectIndex =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['sellprice'] ??
            '';
    return Container(
  ...
  Widget _sellNewold(BuildContext context) {
    var _selectIndex =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['newold'] ??
            '';
    return Container(
      alignment: Alignment.centerLeft,
      margin: EdgeInsets.all(8),
  ...
  Widget _goodflaw(BuildContext context) {
    var _filters =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['flaws'] ?? [];
    return Container(
      alignment: Alignment.centerLeft,
      margin: EdgeInsets.all(8),
      width: MediaQuery.of(context).size.width,
  ...
  Widget _goodversion(BuildContext context) {
    var _selectIndex =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['version'] ??
            '';
    return Container(
      alignment: Alignment.centerLeft,
      margin: EdgeInsets.all(8),
  ...
  Widget _changeDirectBuy(BuildContext context) {
    bool ifDirectBuy = context
            .watch<ChangeOnSellDataCenter>()
            .changeonsellgood['ifDirectBuy'] ??
        false;
    return Container(
        child: Switch(
            value: ifDirectBuy,
            onChanged: (bool v) async {
              if (ifDirectBuy == true) {
                await Provider.of<ChangeOnSellDataCenter>(context,
                        listen: false)
                    .changeifDirectBuy(false);
              } else {
                await Provider.of<ChangeOnSellDataCenter>(context,
                        listen: false)
                    .changeifDirectBuy(true);
              }
            }));
  }
  ...
  Widget _changeOnsellState(BuildContext context) {
    bool ifOnSell =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['ifOnSell'] ??
            false;
    return Container(
        child: Switch(
            value: ifOnSell,
            onChanged: (bool v) async {
              if (ifOnSell == true) {
                ...
                await Provider.of<ChangeOnSellDataCenter>(context,
                        listen: false)
                    .changeOnSellState(false);
              } else {
                //ifOnSell = false;
                await Provider.of<ChangeOnSellDataCenter>(context,
                        listen: false)
                    .changeOnSellState(true);
              }
            }));
  }
  ...
  Widget build(BuildContext context) {
    var good = context.watch<ChangeOnSellDataCenter>().changeonsellgood;
  ...
  Widget _sellDeliveryTime(BuildContext context) {
    var _selectIndex = context
            .watch<ChangeOnSellDataCenter>()
            .changeonsellgood['deliveryTime'] ??
        '';
  ...
  Widget _goodtags(BuildContext context) {
    var _filters =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['tags'] ?? [];
    return Container(
      alignment: Alignment.centerLeft,
      margin: EdgeInsets.all(8),
      width: MediaQuery.of(context).size.width,
  ...
  Widget _goodSubject(BuildContext context) {
    var _selectIndex =
        context.watch<ChangeOnSellDataCenter>().changeonsellgood['subject'] ??
            '';
                    ...
                    content: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            OutlinedButton(
                                onPressed: () async {
                                  await Provider.of<ChangeOnSellDataCenter>(
                                          context,
                                          listen: false)
                                      .changeBookTitle(_infochange.text);
                                },
                                child: Text('提交'))
                          ],
                        )),
                            ...
                            OutlinedButton(
                                onPressed: () async {
                                  await Provider.of<ChangeOnSellDataCenter>(
                                          context,
                                          listen: false)
                                      .changeBookPrice(_infochange.text);
                                },
                                child: Text('提交'))
                          ],
                        )),
                            ...
                            OutlinedButton(
                                onPressed: () async {
                                  await Provider.of<ChangeOnSellDataCenter>(
                                          context,
                                          listen: false)
                                      .changeBookPubdate(_infochange.text);
                                },
                                child: Text('提交'))
                          ],
                        )),
